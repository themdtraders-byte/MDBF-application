...
const TABS = [
    { value: "supplier-list", icon: Icons.supplierList, label: "supplierList" },
    { value: "add-supplier", icon: Icons.addSupplier, label: "addSupplier" },
    { value: "pending-payables", icon: Icons.pendingPayables, label: "pendingPayables" },
                ...
                <main className="p-4 sm:p-6">
                    <SwipeableTabs value={activeTab} onValueChange={setActiveTab}>
                        ...
                        <SwipeableTabsCarousel value={activeTab} onValueChange={setActiveTab}>
                            <SwipeableTabsContent value="supplier-list">
                               <SupplierListTable />
                            </SwipeableTabsContent>
                            <SwipeableTabsContent value="add-supplier">
