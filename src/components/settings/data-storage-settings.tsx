...
export function DataStorageSettings() {
  ...
  const handleRestore = async () => {
    ...
    reader.onload = async (e) => {
        try {
            ...
            // This is the correct call to the robust restore function
            ...
            // Reload the page to ensure all components re-sync with the new data
  ...
  return (
    ...
    <Card>
      ...
      <CardFooter>
         <Button variant="destructive" onClick={handleRestore} disabled={!restoreFile}>
